...
import com.esprit.IDAO.IPanierDAO;
import com.esprit.Util.DataSource;
import com.esprit.entites.Facture;
import com.esprit.entites.Panier;
import com.esprit.DAO.FactureDAO;
import com.esprit.DAO.LigneFactureDAO;
...
//        jLabel1.setBounds(0, 0, 1308, 566);
                ...
                String iconPath=System.getProperty("user.dir")+"/IconsSawssen/";
    ...
    return lbl;
     ...
     public class GenererPDFAction extends AbstractAction{ 
        ...
        try {
            ...
            JasperDesign jasperDesign = JRXmlLoader.load("/home/haw007/facture.jrxml");
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, "/home/haw007/facture.pdf");
...
java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new DisplayPanier(pan,pandao).setVisible(true);
            }
        });
}
