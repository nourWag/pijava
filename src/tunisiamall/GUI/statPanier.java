...
public class statPanier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1308, 600));
        setMinimumSize(new java.awt.Dimension(1308, 600));
        setPreferredSize(new java.awt.Dimension(1308, 600));
        getContentPane().setLayout(null);

        jButton1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tunisiamall/GUI/piechart.png"))); // NOI18N
        ...
        jButton1.setBounds(390, 490, 181, 57);

        jButton2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tunisiamall/GUI/1459973210_graphs.png"))); // NOI18N
        ...
        jButton2.setBounds(580, 490, 177, 57);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      PanierproduitDAO  prdao = new PanierproduitDAO();
        ...
        try {
            while(rspr.next())
            pieDataset.setValue(rspr.getString("nom"),(rspr.getInt("quantite")*100)/qtg );
...
//           frame.setSize(600,700);
    ...
    ResultSet rspr=prdao.statProduits(1);
        ...
        try {
            while(rspr.next()){
                barChartData.setValue(rspr.getInt("quantite"),"",rspr.getString("nom"));}
        } catch (SQLException ex) {
            Logger.getLogger(statPanier.class.getName()).log(Level.SEVERE, null, ex);
        }
